...
'use strict';var makeEl=require('./makeEl.js');function makeButtons(a){var b=makeEl('div',{class:'dp-modal-buttons'});if(a){var c=makeEl('button',{id:'dp-modal-cancel'},'cancel');b.appendChild(c);var d=makeEl('button',{id:'dp-modal-confirm'},'okay');return b.appendChild(d),b}var f=makeEl('button',{id:'dp-modal-cancel'},'close');return b.appendChild(f),b}var create=function(a){var c=Object.assign({},{title:'Dub+',content:'',value:'',placeholder:null,maxlength:999,confirmCallback:null},a),d=makeEl('div',{class:'dp-modal'}),f=makeEl('aside',{class:'container'}),g=makeEl('div',{class:'title'}),h=makeEl('h1',{},c.title);g.appendChild(h);var i=makeEl('div',{class:'content'}),j=makeEl('p',{},c.content);if(i.appendChild(j),c.placeholder){var l=makeEl('textarea',{placeholder:c.placeholder,maxlength:c.maxlength},c.value);i.appendChild(l)}var k=makeButtons(c.confirmCallback);f.appendChild(g),f.appendChild(i),f.appendChild(k),d.appendChild(f),document.body.appendChild(d),'function'==typeof c.confirmCallback&&$('#dp-modal-confirm').one('click',function(){c.confirmCallback(),$('.dp-modal').remove()}),$('#dp-modal-cancel').one('click',function(){$('.dp-modal').remove()}),$(document).one('keyup',function(l){13===l.keyCode&&'function'==typeof c.confirmCallback&&(c.confirmCallback(),$('.dp-modal').remove()),27===l.keyCode&&$('.dp-modal').remove()})},close=function(){$('.dp-modal').remove()};module.exports={create:create,close:close};
...
'use strict';Object.defineProperty(exports,'__esModule',{value:!0});function _defineProperty(a,b,c){return b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c,a}var settings=require('../lib/settings.js'),makeEl=require('./makeEl.js');function preload(){var a=['font-family: \'Trebuchet MS\', Helvetica, sans-serif','z-index: 2147483647','color: white','position: fixed','top: 69px','right: 13px','background: #222','padding: 10px','line-height: 1','-webkit-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75)','-moz-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75)','box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75)','border-radius: 5px','overflow: hidden','width: 230px'].join(';'),b=['float:left','width: 26px','margin-right:5px'].join(';'),c=['display: table-cell','width: 10000px','padding-top:5px'].join(';'),d=new Image;d.src=settings.srcRoot+'/images/dubplus.svg',d.alt='Dub+';var e=makeEl('div',{style:b});if(e.appendChild(d),'animate'in e){var g={iterations:Infinity,iterationStart:0,delay:0,endDelay:0,direction:'alternate',duration:800,fill:'forwards',easing:'ease-in-out'};e.animate([{transform:'rotate(0deg)'},{transform:'rotate(360deg)'}],g)}var h=makeEl('span',{style:c},'Waiting for Dubtrack...'),i=makeEl('div',_defineProperty({style:c,class:'dubplus-waiting'},'style',a));i.appendChild(e),i.appendChild(h),document.body.appendChild(i)}preload(),exports.default=preload;
