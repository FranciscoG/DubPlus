...
(function (TIME_STAMP){
'use strict';var settings=require('../lib/settings.js'),makeLink=function(a,b){var c=document.createElement('link');return c.rel='stylesheet',c.type='text/css',c.className=a?'dubplus-loaded-css '+a:'dubplus-loaded-css',c.href=b,c},load=function(a,b){if(a){var c=makeLink(b,settings.srcRoot+a+'?'+TIME_STAMP);document.head.appendChild(c)}},loadExternal=function(a,b){if(a){var c=makeLink(b,a);document.head.appendChild(c)}};module.exports={load:load,loadExternal:loadExternal};

}).call(this,'1533758973472')
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});function makeEl(a,b,c){var d=document.createElement(a);for(var e in b)d.setAttribute(e,b[e]);return c&&(d.textContent=c),d}exports.default=makeEl;

},{}],43:[function(require,module,exports){
'use strict';var _makeEl=require('./makeEl.js'),_makeEl2=_interopRequireDefault(_makeEl);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function makeButtons(a){var b=(0,_makeEl2.default)('div',{class:'dp-modal-buttons'});if(a){var c=(0,_makeEl2.default)('button',{id:'dp-modal-cancel'},'cancel');b.appendChild(c);var d=(0,_makeEl2.default)('button',{id:'dp-modal-confirm'},'okay');return b.appendChild(d),b}var f=(0,_makeEl2.default)('button',{id:'dp-modal-cancel'},'close');return b.appendChild(f),b}var create=function(a){var c=Object.assign({},{title:'Dub+',content:'',value:'',placeholder:null,maxlength:999,confirmCallback:null},a),d=(0,_makeEl2.default)('div',{class:'dp-modal'}),f=(0,_makeEl2.default)('aside',{class:'container'}),g=(0,_makeEl2.default)('div',{class:'title'}),h=(0,_makeEl2.default)('h1',{},c.title);g.appendChild(h);var i=(0,_makeEl2.default)('div',{class:'content'}),j=(0,_makeEl2.default)('p',{},c.content);if(i.appendChild(j),c.placeholder){var l=(0,_makeEl2.default)('textarea',{placeholder:c.placeholder,maxlength:c.maxlength},c.value);i.appendChild(l)}var k=makeButtons(c.confirmCallback);f.appendChild(g),f.appendChild(i),f.appendChild(k),d.appendChild(f),document.body.appendChild(d),'function'==typeof c.confirmCallback&&$('#dp-modal-confirm').one('click',function(){c.confirmCallback(),$('.dp-modal').remove()}),$('#dp-modal-cancel').one('click',function(){$('.dp-modal').remove()}),$(document).one('keyup',function(l){13===l.keyCode&&'function'==typeof c.confirmCallback&&(c.confirmCallback(),$('.dp-modal').remove()),27===l.keyCode&&$('.dp-modal').remove()})},close=function(){$('.dp-modal').remove()};module.exports={create:create,close:close};
...
'use strict';Object.defineProperty(exports,'__esModule',{value:!0});var _makeEl2=require('./makeEl.js'),_makeEl3=_interopRequireDefault(_makeEl2);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}function _defineProperty(a,b,c){return b in a?Object.defineProperty(a,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):a[b]=c,a}var settings=require('../lib/settings.js');function preload(){var a=['font-family: \'Trebuchet MS\', Helvetica, sans-serif','z-index: 2147483647','color: white','position: fixed','top: 69px','right: 13px','background: #222','padding: 10px','line-height: 1','-webkit-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75)','-moz-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75)','box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75)','border-radius: 5px','overflow: hidden','width: 230px'].join(';'),b=['float:left','width: 26px','margin-right:5px'].join(';'),c=['display: table-cell','width: 10000px','padding-top:5px'].join(';'),d=new Image;d.src=settings.srcRoot+'/images/dubplus.svg',d.alt='Dub+';var e=(0,_makeEl3.default)('div',{style:b});if(e.appendChild(d),'animate'in e){var g={iterations:Infinity,iterationStart:0,delay:0,endDelay:0,direction:'alternate',duration:1500,fill:'forwards',easing:'ease-in-out'};e.animate([{transform:'rotate(0deg)'},{transform:'rotate(360deg)'}],g)}var h=(0,_makeEl3.default)('span',{style:c},'Waiting for Dubtrack...'),i=(0,_makeEl3.default)('div',_defineProperty({style:c,class:'dubplus-waiting'},'style',a));i.appendChild(e),i.appendChild(h),document.body.appendChild(i)}exports.default=preload;
